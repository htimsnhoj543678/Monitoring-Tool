...
public class UI extends JFrame
{
    ...
    String onlineImagePath = "src\\resources\\greencircle15x15.png";
    String offlineImagePath = "src\\resources\\redcircle15x15.png";
    String firewallImagePath = "src\\resources\\bluecircle15x15.png";
    ...
    public void createLabels(int nodeX, int nodeY,String name)
    {
    ...
    public void createNode(Node node)
    {
        ...
        nodeLabel = new CityNode(node.getXpos(),node.getYpos(),node.getColor());
        nodeLabel.setBounds(0,0,backgroundMap.getWidth(),backgroundMap.getHeight());
